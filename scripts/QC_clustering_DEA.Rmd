...
Unsupervised clustering and overlaying of the group conditions, show that there could be some effects. This is evidenced by the fact that some cells cluster separately based on their tissue of origin. There are also some clusters with overlaps. CRC, LM and PBMC are different tissues. This might also explain the differences in clustering. In any ways, it will be beneficial to do data integration to see if the differences in clustering is biological or technical.
